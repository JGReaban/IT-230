...
namespace ConsoleRegisterStudent
{
    class Program
    {
        ...
        void run()
        {
            ...
            do
            {
                // write name for every screenshot
                System.Console.WriteLine("Reaban, Jeremy's Week Five Milestone One \n");
                WritePrompt();
        ...
        {
            //
            //  Re-wrote this to make sure the appropriate error value is given
            //
            int returnValue = 0;
